            ...
            do {
                ...
                switch (pil07256){
                    ...
                    case 3 : {
                        ...
                        if(pilihs07256>=0 && pilihs07256-1<sepatuProcess07256.getSepatuEntity07256().size()){
                            System.out.print("Masukan nama sepatu baru : ");
                            String nama07256 = scan07256.next();
                            System.out.print("Masukan stock sepatu baru : ");
                            int stock07256 = scan07256.nextInt();
                            sepatuProcess07256.updateSepatu(pilihs07256-1,nama07256,stock07256);
                        }else{
                    ...
                    case 4 : {
                        ...
                        if(pilih07256>=0 && pilih07256-1<sepatuProcess07256.getSepatuEntity07256().size()){
                            sepatuProcess07256.deleteSepatu(pilih07256-1);
