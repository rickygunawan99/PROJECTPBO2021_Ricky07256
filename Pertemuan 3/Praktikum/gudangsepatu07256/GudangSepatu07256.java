...
public class GudangSepatu07256 {
    ...
    private void updateSepatu(){
        ...
        if(sepatuController07256.getSepatu07256(id).getId07256() > 0){
            ...
            switch (pil07256) {
                ...
                default -> System.out.println("Input tidak ditemukan");
            }
        }else
    ...
    private void delete07256(){
        ...
        if(sepatuController07256.getSepatu07256(id07256).getId07256() > 0){
